  ...
  if (void 0 !== $.plot) {
    ...
    var n = {
      ...
      legend: {
        ...
        labelFormatter: function labelFormatter(e, a) {
          return e + "&nbsp;&nbsp;";
        },
        width: 40,
        height: 1
...
function init_daterangepicker() {
  if (void 0 !== $.fn.daterangepicker) {
    var e = function e(_e, a, t) {
      console.log(_e.toISOString(), a.toISOString(), t), $("#reportrange span").html(_e.format("MMMM D, YYYY") + " - " + a.format("MMMM D, YYYY"));
    };
...
function init_daterangepicker_right() {
  if (void 0 !== $.fn.daterangepicker) {
    var e = function e(_e2, a, t) {
      console.log(_e2.toISOString(), a.toISOString(), t), $("#reportrange_right span").html(_e2.format("MMMM D, YYYY") + " - " + a.format("MMMM D, YYYY"));
    };
...
function init_CustomNotification() {
  if (console.log("run_customtabs"), "undefined" != typeof CustomTabs) {
    ...
    var t = 10;
    TabbedNotification = function TabbedNotification(e) {
    ...
    }, CustomTabs = function CustomTabs(e) {
  ...
  if (void 0 !== $.fn.fullCalendar) {
    ...
    var o,
      ...
      i = $("#calendar").fullCalendar({
        ...
        eventClick: function eventClick(e, a, t) {
