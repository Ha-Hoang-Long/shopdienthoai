...
!function (e, t) {
  ...
  ct.Animation = ct.extend(R, {
    ...
    return this.length;
  }, ct.fn.andSelf = ct.fn.addBack, "object" == ( false ? 0 : _typeof(module)) && module && "object" == _typeof(module.exports) ? module.exports = ct : (e.jQuery = e.$ = ct,  true && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return ct;
