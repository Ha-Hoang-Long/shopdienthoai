  ...
  c.extend(c.validator, {
    ...
    prototype: {
      ...
      defaultShowErrors: function defaultShowErrors() {
        ...
        if (this.settings.success) for (a = 0; this.successList[a]; a++) {
      ...
      depend: function depend(a, b) {
        return this.dependTypes[_typeof(a)] ? this.dependTypes[_typeof(a)](a, b) : true;
      },
      dependTypes: {
    ...
    addClassRules: function addClassRules(a, b) {
    ...
    methods: {
      required: function required(a, b, d) {
...
(function (c) {
  ...
  c.extend(c.fn, {
    validateDelegate: function validateDelegate(a, b, d) {
