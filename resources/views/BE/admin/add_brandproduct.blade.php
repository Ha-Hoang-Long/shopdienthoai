...
<div class="col-md-9 col-sm-9 " style="margin: auto;">
	<div class="x_panel">
		...
		<div class="x_content">
			<br>
			<form id="demo-form2" role="form" action="{{url('admin/brand-Product/save-brand-Product')}}" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
			@csrf
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align" for="ma-danh-muc">Mã hãng <span class="required">*</span>
				</label>
