...
<div class="col-md-12 col-sm-12  ">
    <div class="x_panel">
        ...
        <h2>List table <small><?php echo $table_name ?></small></h2>
        <div class="x_content">
            <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php foreach($data as $key => $record){ ?>
                                <td style="vertical-align: auto;">{{$record->Ma_sp}}</td>
                                <td>{{$record->Ten_sp}}</td>
                                ...
                                ?>
                                        <td><a href="{{URL('admin/Product/unactive-Product/'.$record->Ma_sp)}}"><button type="button" class="btn btn-round btn-success">Hiện</button></a></td>
                                        
                                <?php
                                    }else{
                                ?>
                                        <td><a href="{{URL('admin/Product/active-Product/'.$record->Ma_sp)}}"><button type="button" class="btn btn-round btn-warning">Ẩn</button></a></td>
                                <?php
                                    }  
                                ?>
                                ...
                                <td>
                                    <a href="{{URL('admin/Product/edit-Product/'.$record->Ma_sp)}}" class="active" ui-toggle-class=""><button type="button" class="btn btn-warning btn-sm">EDIT</button></a>
                                    <br>
                                    <a href="{{URL('admin/Product/delete-Product/'.$record->Ma_sp)}}" class="active" ui-toggle-class="" onclick="return confirm('Bạn chắc chắn muốn xóa? Dữ liệu sẽ không thể khôi phục')"><button type="button" class="btn btn-danger btn-sm">DEL</button></a>
                                </td>
                                </tr>   
                            <?php } ?>
