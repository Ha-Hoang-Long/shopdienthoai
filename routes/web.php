...
Route::get('/search-history-order',[HomeController::class,'search_history_order'])->name('fe.search_history_order');

Route::get('/history-order',[HomeController::class,'order_history'])->name('order_history');
